...
import { View, ImageBackground, Image, Text, FlatList, TouchableOpacity, Modal, ScrollView, StyleSheet } from 'react-native';
            ...
            renderItem={({ item, index }) => (
              <View style={styles.card}>
                ...
                <View style={styles.buttonGroup}>
                  <TouchableOpacity onPress={() => handleShowContacts(index)}>
...
const styles = StyleSheet.create({
    ...
    overlay: {
      ...
      padding: 20,
      paddingBottom: 70, // Increase bottom padding to accommodate the toolbar height
    },
    backButton: {
      position: 'absolute',
      top: 23,
    ...
    bottomToolbar: {
      position: 'absolute', // Position absolute makes the toolbar sticky at the bottom
      zIndex: 1,
      bottom: 0,
      left: 0,
      right: 0,
